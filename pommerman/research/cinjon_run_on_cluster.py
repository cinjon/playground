...
# train_dagger_job(
#     {"num-processes": 8, "run-name": "ex-uvl", "how-train": "dagger", "num-episodes-dagger": 25, "log-interval": 25,
#      "minibatch-size": 2000, "save-interval": 25, "lr": 0.005, "num-steps-eval": 100,
#      "log-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/logs/", 
#      "save-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/models/", 
#      "config": "PommeTeamShort-v0", "gamma": ".99", "expert-prob": 0.5, "model-str": "PommeCNNPolicySmaller",
#  }
# )
# train_dagger_job(
#     {"num-processes": 8, "run-name": "ex-uvl", "how-train": "dagger", "num-episodes-dagger": 30, "log-interval": 25,
#      "minibatch-size": 2000, "save-interval": 25, "lr": 0.005, "num-steps-eval": 100,
#      "log-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/logs/", 
#      "save-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/models/", 
#      "config": "PommeTeamShort-v0", "gamma": ".99", "expert-prob": 0.5, "model-str": "PommeCNNPolicySmaller",
...
# )
# train_dagger_job(
#     {"num-processes": 8, "run-name": "ex-uvl", "how-train": "dagger", "num-episodes-dagger": 20, "log-interval": 25,
#      "minibatch-size": 2000, "save-interval": 25, "lr": 0.005, "num-steps-eval": 100,
#      "log-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/logs/", 
#      "save-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/models/", 
#      "config": "PommeTeamShort-v0", "gamma": ".99", "expert-prob": 0.5, "model-str": "PommeCNNPolicySmaller",
...
# train_dagger_job(
#     {"num-processes": 8, "run-name": "ex-uvl", "how-train": "dagger", "num-episodes-dagger": 20, "log-interval": 25,
#      "minibatch-size": 2000, "save-interval": 25, "lr": 0.01, "num-steps-eval": 100,
#      "log-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/logs/", 
#      "save-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/models/", 
#      "config": "PommeTeamShort-v0", "gamma": ".99", "expert-prob": 0.5, "model-str": "PommeCNNPolicySmaller",
#  }
...
###### NOTE: THIS DIDNT GET STARTED
### These are ppo ffa jobs where we distill from Dagger but with much bigger batch sizes.
# train_ppo_job( # This job will have batch size of 400
#     {"num-processes": 8, "run-name": "bigbatch", "how-train": "simple", "log-interval": 100,
#      "log-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/logs/", 
#      "save-dir": "/misc/kcgscratch1/ChoGroup/resnick/selfplayground/models/", 
#      "config": "PommeFFAShort-v0", "gamma": ".99", "lr": 0.0003,
#      "model-str": "PommeCNNPolicySmaller", "num-mini-batch": 4, "num-steps": 200,
#      "distill-expert": "DaggerAgent", "restart-counts": "", "distill-epochs": 5000,
#      "distill-target": "dagger::/home/resnick/Code/selfplayground/thisone-dagger-save-eval-env-done-rand-seed.ht-dagger.cfg-PommeFFA-v3.m-PommeCNNPolicySmall.nc-256.lr-0.005-.mb-5000.ns-5000.num-0.epoch-580.steps-34860000.seed-0.pt",
#     }, "pmanDSDag"
# )
